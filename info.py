...
API_ID = int(environ.get('API_ID', '26506871'))
API_HASH = environ.get('API_HASH', '5f7c05d91ce123db6d36f9296e96f0a')
BOT_TOKEN = environ.get('BOT_TOKEN', "6765960579:AAHYy9-pTCPoSaFZuk64oOfk1CxRKDp2ezU")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6317970327').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001880871344').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://RAMAMOVIES:RAMAMOVIES@cluster0.nxhgkhn.mongodb.net/?retryWrites=true&w=majority")
...
SHORTLINK_API = environ.get('SHORTLINK_API', '5f4f5d262063b8a6ec2780649842844f44a8d725')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002025823771'))
...
URL = "https://moviesaura.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://moviesaura.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://moviesaura.onrender.com/".format(FQDN)
else:
    URL = "https://moviesaura.onrender.com/".format(FQDN)
